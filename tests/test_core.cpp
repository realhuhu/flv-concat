...
std::vector<std::uint8_t> make_h265_regenerated_configuration() {
    // The short first segment from the 20260808 来聂卫平杯 recording. Its
    // VPS/SPS/PPS payloads have different reference-picture defaults, but the
    // decoded format is the same 1080x1920 8-bit 4:2:0 HEVC stream.
    return {
        0x01, 0x01, 0x60, 0x00, 0x00, 0x00, 0xB0, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x78, 0xF0, 0x00, 0xFC, 0xFD, 0xF8, 0xF8, 0x00, 0x00, 0x0F, 0x03,
        0xA0, 0x00, 0x01, 0x00, 0x18, 0x40, 0x01, 0x0C, 0x01, 0xFF, 0xFF, 0x01,
        0x60,
        0x00, 0x00, 0x03, 0x00, 0xB0, 0x00, 0x00, 0x03, 0x00, 0x00, 0x03,
        0x00, 0x78, 0x15, 0xC0, 0x90, 0xA1, 0x00, 0x01, 0x00, 0x24, 0x42,
        0x01, 0x01, 0x01, 0x60, 0x00, 0x00, 0x03, 0x00, 0xB0, 0x00, 0x00,
        0x03, 0x00, 0x00, 0x03, 0x00, 0x78, 0xA0, 0x02, 0x20, 0x80, 0x1E,
        0x07, 0x2F, 0x88, 0x15, 0xEE, 0x45, 0x95, 0x4D, 0x40, 0x40, 0x40,
        0x40, 0x20, 0xA2, 0x00, 0x01, 0x00, 0x07, 0x44, 0x01, 0xC0, 0x2C, 0xBC,
        0x14, 0xC9};
}
...
void test_h265_probe_and_scanner() {
    ...
    auto regenerated_variant = info;
    regenerated_variant.video_config = make_h265_regenerated_configuration();
    const auto regenerated_compatible =
        flvconcat::media_compatible(info, regenerated_variant, error);
